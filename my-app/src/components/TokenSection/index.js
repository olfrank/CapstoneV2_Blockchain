      ...
      <TokenInfoSection>
        <TokenContainer>
          ...
          <InputContainer>
            ...
            <input type="text" className = "token-input" id="contractOwner" value={contractOwner} disabled={true}/>
            <button onClick={getContractOwner} className = "btn btn-contract-owner" >Get Contract Owner</button>
          </InputContainer>

          <InputContainer>
            <label>Token Owner</label>
            <input class = "token-input" type="text"  onChange={e => setTokenOwner(e.target.value)}/>
            <button onClick={getTokenOwnerInfo} className = "btn btn-contract-owner">Get Token Information</button>
          </InputContainer>

          <InputContainer>
          <label>Token Balance</label>
          <input type="text" className = "token-input" value={tokenBalance} disabled={true}/>
          </InputContainer>

          <DropMenuTokens>
            <label>Owned Tokens</label>
            <select id = "owned-tokens" className = "token-input" onChange={e =>setTokenItem(e.target.value)} >
          ...
          <InputContainer>
            ...
            <input  type="text" className = "token-input" id="tokenId" value={tokenItem} disabled={true}/>
          </InputContainer>
          <InputContainer>
            <label>Token URI</label>
            <input type="text" className = "token-input" id="tokenURI" value={tokenURI} disabled={true}/>
          </InputContainer>
        </TokenContainer>
      </TokenInfoSection>
    )
